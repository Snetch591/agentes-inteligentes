...
Agente reativo baseado em utilidade: performace(alcançar o objetivo com menor custo possível), enviroment(pode ser totalmente ou parcialmente observável), actuators(movimentos no grid), sensors(percepção local ou global baseada no A* ou LocalProximoMovimento())
